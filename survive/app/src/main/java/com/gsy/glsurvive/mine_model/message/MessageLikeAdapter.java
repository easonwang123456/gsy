...
public class MessageLikeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<MessageLikeResult.ContentBean> mDatas = new ArrayList<>();
    ...
    public void addDatas(ArrayList<MessageLikeResult.ContentBean> datas,Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.message_recycler_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if(viewHolder instanceof Holder) {
            ...
            ((Holder) viewHolder).nickName.setText(mDatas.get(pos).getNickName());
            ((Holder) viewHolder).content.setText(mDatas.get(pos).getText());
            Picasso.with(context).load(mDatas.get(pos).getUserImg()).into(((Holder) viewHolder).img);
    ...
    class Holder extends RecyclerView.ViewHolder {
        ImageView img;
        TextView nickName,time,content,title;
