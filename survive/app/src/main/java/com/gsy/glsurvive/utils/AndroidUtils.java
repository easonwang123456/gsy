...
//        LogUtil.d(TAG, "error msg = " + result.errorMsg);
//        LogUtil.d(TAG, "success msg = " + result.successMsg);
...
//    }
    ...
    public static String getPackageName(Context context) {
        Log.e("msg","getPackageName:"+getPackageInfo(context).packageName);
    ...
    public static void openAppWithAction(Context context, String packageName, String activity) {
        ...
        try {
            ...
            Log.e(TAG, "没有找到应用程序:packageName:" + packageName + "  activity:" + activity);
    ...
    public static void install(Context context, File file) {
        Log.e(TAG, "install Apk:" + file.getName());
