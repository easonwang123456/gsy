...
public class FirstSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final int TYPE_HEADER = 0;
    public static final int TYPE_NORMAL = 1;
    private Context context;

    private ArrayList<FirstSearchResult.ContentBean> mDatas = new ArrayList<>();
    ...
    public void addDatas(ArrayList<FirstSearchResult.ContentBean> datas,Context context) {
        this.context=context;
        this.mDatas.addAll(datas);
    }
    public void refresh(ArrayList<FirstSearchResult.ContentBean> datas,Context context) {
        this.context=context;
        this.mDatas=datas;
