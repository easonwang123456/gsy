...
public class RookieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final int TYPE_HEADER = 0;
    public static final int TYPE_NORMAL = 1;
    private Context context;

    private ArrayList<RookieResult.ContentBean.PostDataBean> mDatas = new ArrayList<>();
    ...
    public void addDatas(ArrayList<RookieResult.ContentBean.PostDataBean> datas,Context context) {
        this.context=context;
        this.mDatas.addAll(datas);
    }
    public void refresh(ArrayList<RookieResult.ContentBean.PostDataBean> datas,Context context) {
        this.context=context;
        this.mDatas=datas;
