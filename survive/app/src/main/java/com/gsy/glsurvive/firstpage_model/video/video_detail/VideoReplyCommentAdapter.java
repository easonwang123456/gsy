 ...
 */
public class VideoReplyCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<VideoCommentResult.ContentBean.ReplyBean> mDatas = new ArrayList<>();
    ...
    public void addDatas(ArrayList<VideoCommentResult.ContentBean.ReplyBean> mDatas,Context context) {
