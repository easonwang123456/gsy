...
import com.gsy.glsurvive.firstpage_model.FirstPageAdapter;
...
public class GunRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final int TYPE_HEADER = 0;
    public static final int TYPE_NORMAL = 1;
    private Context context;
    //private ArrayList<FirstPageRecommandResult.ContentBean.PostDataBean> list;

//    public GunGridAdapter(Context context,ArrayList<FirstPageRecommandResult.ContentBean.PostDataBean> list) {
