...
public class CollectAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OnLongClickListener longListener;
    public void setOnLongClickListener(OnLongClickListener li) {
        longListener = li;
    }
    ...
    public void addDatas(ArrayList<CollectListResult.ContentBean> datas, Activity activity,Context context) {
        Log.e("msg","data1:"+datas);
        this.context=context;
        this.mDatas.addAll(datas);
        notifyDataSetChanged();
    }
    public void refresh(ArrayList<CollectListResult.ContentBean> datas, Activity activity,Context context) {
        Log.e("msg","data1:"+datas);
        this.context=context;
        this.mDatas=datas;
        notifyDataSetChanged();
        ...
        if(viewHolder instanceof Holder) {
            ...
            viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    longListener.onLongClick(pos, mDatas.get(pos).getId(),mDatas.get(pos).getType(),""+mDatas.get(pos).getCollectId());
                    return false;
                }
            });
        }
    ...
    interface OnLongClickListener {
        void onLongClick(int position, int id, int type,String collectId);
    }
