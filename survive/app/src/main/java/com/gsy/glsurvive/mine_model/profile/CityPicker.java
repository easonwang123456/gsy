...
import com.gsy.glsurvive.view.CanShow;
import com.gsy.glsurvive.view.OnWheelChangedListener;
import com.gsy.glsurvive.view.WheelView;
import com.gsy.glsurvive.view.XmlParserHandler;
import com.gsy.glsurvive.location_adapter.ArrayWheelAdapter;
import com.gsy.glsurvive.model.CityModel;
import com.gsy.glsurvive.model.DistrictModel;
import com.gsy.glsurvive.model.ProvinceModel;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
    ...
    public CityPicker(ProfileView profileView) {
    ...
    private CityPicker(CityPicker.Builder builder) {
        ...
        popview = layoutInflater.inflate(R.layout.location_wheel_view, null);
        ...
        mTvOK = (TextView) popview.findViewById(R.id.location_confirm);
        mTvTitle = (TextView) popview.findViewById(R.id.tv_title);
        mTvCancel = (TextView) popview.findViewById(R.id.location_cancel);
