...
public class StrategyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<EachStrategyResult.ContentBean.PostDataBean> mDatas = new ArrayList<>();
    ...
    public void addDatas(ArrayList<EachStrategyResult.ContentBean.PostDataBean> datas,Context context) {
        this.context=context;
         mDatas.addAll(datas);
        notifyDataSetChanged();
    }
    public void refresh(ArrayList<EachStrategyResult.ContentBean.PostDataBean> datas,Context context) {
        this.context=context;
        mDatas=datas;
        notifyDataSetChanged();
    }
