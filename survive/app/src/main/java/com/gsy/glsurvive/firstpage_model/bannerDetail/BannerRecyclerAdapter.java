...
public class BannerRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final int TYPE_HEADER = 0;
    public static final int TYPE_NORMAL = 1;
    private Context context;

    private ArrayList<BannerDetailResult.ContentBean.OtherDataBean> mDatas = new ArrayList<>();
    ...
    public void addDatas(ArrayList<BannerDetailResult.ContentBean.OtherDataBean> datas,Context context) {
