...
public class GridAdapter extends BaseAdapter {
	...
	private ArrayList<GunResult.ContentBean> list;

	public GridAdapter(Context context, ArrayList<GunResult.ContentBean> list) {
		super();
	...
	public void updateAdapter(ArrayList<GunResult.ContentBean> list){
		this.list=list;
		notifyDataSetChanged();
	}

	public ArrayList<GunResult.ContentBean> getList() {
		return list;
	}
